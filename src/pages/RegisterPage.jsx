      ...
      <div className={`auth-wrapper ${mounted ? 'slide-up-fade-in' : ''}`}>
        <div className="auth-left-panel">
          <div className="brand-showcase">
            <div className="brand-logo-container float-anim">
              <img src="/logo.png" alt="Logo" style={{width: '100%', height: '100%', objectFit: 'contain', borderRadius: '20px', padding: '10px'}} />
            </div>
        ...
        <div className="auth-right-panel">
          <div className="auth-form-container">
            <div className="auth-form-header" style={{ textAlign: 'center', marginBottom: '30px' }}>
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '15px' }}>Yangi o'quvchi profilini yarating</p>
            </div>
