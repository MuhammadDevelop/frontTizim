...
const API_BASE = import.meta.env.VITE_API_URL || (window.location.hostname === 'localhost' ? 'http://localhost:8000/api/v1' : 'https://natija-ro6w.onrender.com/api/v1');
...
export const ReceptionAPI = {
  ...
  teachers: () => client.get('/reception/teachers'),
...
export const StudentAPI = {
  ...
  faceAttendance: (data) => client.post('/face-id/verify', data),
  faceEnroll: (student_id, data) => client.post(`/face-id/register/${student_id}`, data),
